...
CREATE TABLE "auth_vault" (
	"id" uuid PRIMARY KEY DEFAULT '28bbc907-fd06-4a16-a3a3-c5cee6d2acc3' NOT NULL,
	"user_id" uuid NOT NULL,
	"tokenType" "auth_token_type" NOT NULL,
...
CREATE INDEX "auth_vault_user_id_token_type_idx" ON "auth_vault" USING btree ("user_id","tokenType" DESC NULLS LAST);--> statement-breakpoint
...
CREATE INDEX "auth_vault_session_state_idx" ON "auth_vault" USING btree ("session_state");